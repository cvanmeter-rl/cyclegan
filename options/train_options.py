...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # --- Task model (teacher) ---
        self.parser.add_argument('--seg_checkpoint', type=str, required=True,
        ...
        self.parser.add_argument('--seg_encoder', type=str, default='vitl')
        self.parser.add_argument('--seg_decoder', type=str, default='dpt')
        ...
        self.parser.add_argument('--seg_mean', type=float, nargs=3, default=[123.675, 116.28, 103.53])
        self.parser.add_argument('--seg_std',  type=float, nargs=3, default=[58.395, 57.12, 57.375])
        
        # (optional) center crop fed to the task model; omit if not used
        self.parser.add_argument('--seg_crop', type=int, nargs=2, default=[504,504])
        
        # (recommended) to keep labels consistent
        self.parser.add_argument('--ignore_index', type=int, default=255)
        self.parser.add_argument('--mask_dir_A',type=str,default='/mnt/cycada/cycada/data2/trainA_masks/')
        self.isTrain = True
